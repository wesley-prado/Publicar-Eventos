...
function NovoUsuario() {
  ...
  function cadastrar() {
    ...
    if (!email || !senha) {
      setCarregando(0);
      setMsgTipo('erro');
      setMsg('Você precisa informar um email e senha para fazer o cadastro!');
      return;
    }
      ...
      .catch(erro => {
        ...
        switch (erro.message) {
          ...
          case 'The email address is already in use by another account.':
            setMsg('O endereço de email ja está sendo usado em outra conta');
            break;

          case 'The email address is badly formatted.':
            setMsg('O endereço de email está mal formatado');
            break;
    ...
    <>
      ...
      <div className="form-cadastro">
        <form className="text-center form-login mx-auto mt-5">
          ...
          {carregando ? (
            <button
              className="btn btn-lg btn-block mt-3 mb-5 btn-cadastro text-center"
              type="button"
              disabled
            >
              <span
